...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Certifire UK | Fire Safety Services in London',
    template: '%s | Certifire UK',
  },
  ...
  openGraph: {
    title: 'Certifire UK | Fire Safety Services in London',
    description: 'Fire risk assessments, alarm servicing, emergency lighting checks and regular fire safety logging.',
    type: 'website',
    locale: 'en_GB',
    images: [{ url: logo, width: 1200, height: 1200, alt: 'Certifire UK logo' }],
  },
  twitter: {
